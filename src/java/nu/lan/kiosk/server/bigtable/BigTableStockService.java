package nu.lan.kiosk.server.bigtable;
//
...
//
public class BigTableStockService 
{
}
//}
...
//  }
//
////  private int purchaseCount(String stockItemName){
////    DatastoreService datastore = DatastoreServiceFactory.getDatastoreService();
////    datastore.prepare(new Query("Purchase").addFilter(stockItemName, Query.FilterOperator.EQUAL, ))
////
////    return 0;
////  }
//
